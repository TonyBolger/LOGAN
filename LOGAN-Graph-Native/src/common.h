...
#define TR_LOOKUP_INGRESS_BLOCKMARGIN 100
#define TR_LOOKUP_INGRESS_PILEMARGIN 200000

#define TR_LOOKUP_RECYCLE_BLOCKMARGIN 2
...
#define TR_LOOKUP_RECYCLE_TIGHT_THRESHOLD 230

#define TR_READBLOCK_INGRESS_INFLIGHT 1
#define TR_READBLOCK_LOOKUPS_INFLIGHT 250
#define TR_READBLOCK_LOOKUPS_THRESHOLD 100

//#define TR_READBLOCK_DISPATCHES_INFLIGHT 250


// ~60K usable bricks per chunk, so one chunk per 6 blocks
// Approximate Ratio: 1 : 1.5-2 : 2-3
#define TR_BRICKCHUNKS_SEQUENCE_MIN 50
#define TR_BRICKCHUNKS_SEQUENCE_MAX 50

#define TR_BRICKCHUNKS_LOOKUP_MIN 80
#define TR_BRICKCHUNKS_LOOKUP_MAX 80

#define TR_BRICKCHUNKS_DISPATCH_MIN 140
#define TR_BRICKCHUNKS_DISPATCH_MAX 140
