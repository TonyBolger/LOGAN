...
#define SMER_LOOKUPSLICEGROUPS 64
#define SMER_LOOKUPSLICEGROUP_SHIFT 8
#define SMER_LOOKUPSLICEGROUP_MASK (SMER_LOOKUPSLICEGROUPS-1)
#define SMER_LOOKUPSLICEGROUP_PER_GROUP_SLICES 256
#define SMER_LOOKUPSLICEGROUP_PER_GROUP_SLICEMASK (SMER_LOOKUPSLICEGROUP_PER_GROUP_SLICES-1)


#define SMER_DISPATCHSLICEGROUPS 64
#define SMER_DISPATCHSLICEGROUP_SHIFT 8
#define SMER_DISPATCHSLICEGROUP_MASK (SMER_DISPATCHSLICEGROUPS-1)
#define SMER_DISPATCHSLICEGROUP_PER_GROUP_SLICES 256
#define SMER_DISPATCHSLICEGROUP_PER_GROUP_SLICEMASK (SMER_DISPATCHSLICEGROUP_PER_GROUP_SLICES-1)
