...
#define TR_LOOKUP_BLOCKSIZE 10000
...
#define TR_BRICKCHUNKS_LOOKUP_MAX 20

#define TR_BRICKCHUNKS_DISPATCH_MIN 100
#define TR_BRICKCHUNKS_DISPATCH_MAX 100

//#define TR_POGOSUPPRESSION_LOOKUP_TO_DISPATCH_FRACTION 0.25
//#define TR_POGOSUPPRESSION_DISPATCH_PRIORITY_FRACTION 0.1

//#define TR_POGOSUPRESSION_LOOKUP_TO_DISPATCH_READ_LIMIT ((int)(TR_INGRESS_BLOCKSIZE * TR_READBLOCK_DISPATCHES_INFLIGHT * TR_POGOSUPPRESSION_LOOKUP_TO_DISPATCH_FRACTION))
//#define TR_POGOSUPRESSION_DISPATCH_PRIORITY_READ_LIMIT ((int)(TR_INGRESS_BLOCKSIZE * TR_READBLOCK_DISPATCHES_INFLIGHT * TR_POGOSUPPRESSION_DISPATCH_PRIORITY_FRACTION))
