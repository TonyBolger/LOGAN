...
#define RTP_PACKEDHEADER_PAYLOADSIZE_SHIFT 14
...
#define RTP_PACKEDHEADER_UPSTREAMRANGESIZE_MASK (3<<RTP_PACKEDHEADER_UPSTREAMRANGESIZE_SHIFT)

#define RTP_PACKEDHEADER_DOWNSTREAMRANGESIZE_SHIFT 10
#define RTP_PACKEDHEADER_DOWNSTREAMRANGESIZE_MASK (3<<RTP_PACKEDHEADER_DOWNSTREAMRANGESIZE_SHIFT)

#define RTP_PACKEDHEADER_OFFSETSIZE_SHIFT 8
...
//#define ROUTEPACKING_ENTRYARRAYS_MAX 255
